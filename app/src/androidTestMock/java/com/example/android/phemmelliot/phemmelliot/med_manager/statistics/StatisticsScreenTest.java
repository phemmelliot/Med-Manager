...
public class StatisticsScreenTest {
    ...
    /**
     * Setup your test fixture with a fake task id. The {@link MedicationDetailActivity} is started with
    ...
    public void Tasks_ShowsNonEmptyMessage() throws Exception {
        // Check that the active and completed medications text is displayed
