...
import static com.example.android.phemmelliot.phemmelliot.med_manager.R.id.toolbar;
...
@LargeTest
public class AddEditMedicationScreenTest {
     ...
     */
    @Rule
    public ActivityTestRule<AddMedicationActivity> mActivityTestRule =
            new ActivityTestRule<>(AddMedicationActivity.class, false, false);
    ...
    public void emptyTask_isNotSaved() {
        ...
        onView(withId(R.id.add_medication_name)).perform(clearText());
        onView(withId(R.id.add_medication_description)).perform(clearText());
