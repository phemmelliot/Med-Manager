...
package com.example.android.phemmelliot.phemmelliot.med_manager.statistics;
...
public class StatisticsPresenterTest {
     ...
     */
    @Captor
    private ArgumentCaptor<MedicationsDataSource.LoadMessagesCallback> mLoadTasksCallbackCaptor;
    ...
    public void loadEmptyTasksFromRepository_CallViewToDisplay() {
        // Given an initialized StatisticsPresenter with no medications
        Medications.clear();
    ...
    public void loadNonEmptyTasksFromRepository_CallViewToDisplay() {
        // Given an initialized StatisticsPresenter with 1 active and 2 completed medications
    ...
    public void loadStatisticsWhenTasksAreUnavailable_CallErrorToDisplay() {
        ...
        // And medications data isn't available
        verify(mTasksRepository).getMessages(mLoadTasksCallbackCaptor.capture());
