...
import com.example.android.phemmelliot.phemmelliot.med_manager.addmedication.AddMedicationFragment;
 ...
 */
public class MedicationDetailFragment extends Fragment implements MedicationDetailContract.View {
    ...
    private MedicationDetailContract.Presenter mPresenter;
    ...
    public static MedicationDetailFragment newInstance(@Nullable String taskId) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.medicationdetail_frag, container, false);
    ...
    @Override
    public void setPresenter(@NonNull MedicationDetailContract.Presenter presenter) {
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        inflater.inflate(R.menu.medicationdetail_fragment_menu, menu);
    }
