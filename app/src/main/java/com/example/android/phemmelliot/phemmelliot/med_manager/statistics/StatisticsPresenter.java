...
public class StatisticsPresenter implements StatisticsContract.Presenter {
    ...
    private final MedicationsRepository mTasksRepository;

    private final StatisticsContract.View mStatisticsView;

    public StatisticsPresenter(@NonNull MedicationsRepository tasksRepository,
    ...
    private void loadStatistics() {
        ...
        mTasksRepository.getMessages(new MedicationsDataSource.LoadMessagesCallback() {
            @Override
            public void onMessagesLoaded(List<Medication> medications) {
                ...
                // We calculate number of active and completed medications
