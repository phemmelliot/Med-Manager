...
import static com.example.android.phemmelliot.phemmelliot.med_manager.TestUtils.getToolbarNavigationContentDescription;
import static com.example.android.phemmelliot.phemmelliot.med_manager.custom.action.NavigationViewActions.navigateTo;
import static junit.framework.Assert.fail;

/**
 * Tests for the {@link DrawerLayout} layout component in {@link MedicationsActivity} which manages
...
public class AppNavigationTest {
     ...
     */
    @Rule
    public ActivityTestRule<MedicationsActivity> mActivityTestRule =
            new ActivityTestRule<>(MedicationsActivity.class);
    ...
    public void Statistics_backNavigatesToTasks() {
        ...
        // Press back to go back to the medications list
        pressBack();
    ...
    public void backFromTasksScreen_ExitsApp() {
        // From the medications screen, press back should exit the app.
        assertPressingBackExitsApp();
    }

    @Test
    public void backFromTasksScreenAfterStats_ExitsApp() {
        // This test checks that MedicationsActivity is a parent of StatisticsActivity

        // Open the stats screen
        openStatisticsScreen();

        // Open the medications screen to restore the task
        openTasksScreen();
